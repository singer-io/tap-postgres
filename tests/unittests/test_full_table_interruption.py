    ...
    def test_catalog(self):
        ...
        try:
            ...
            tap_postgres.do_sync(get_test_connection_config(), {
                                 'streams': streams}, None, None, state)
        ...
        end_lsn = CAUGHT_MESSAGES[1].value['bookmarks']['postgres-public-COW'].get(
            'lsn')

        self.assertTrue(isinstance(
            CAUGHT_MESSAGES[2], singer.ActivateVersionMessage))
        ...
        CAUGHT_MESSAGES.clear()
        tap_postgres.do_sync(get_test_connection_config(), {
                             'streams': streams}, None, None, old_state)
        ...
        self.assertEqual(CAUGHT_MESSAGES[5].value['bookmarks']
                         ['postgres-public-COW'].get('version'), new_version)

        self.assertTrue(isinstance(
            CAUGHT_MESSAGES[6], singer.ActivateVersionMessage))
        ...
        self.assertEqual(CAUGHT_MESSAGES[7].value['bookmarks']
                         ['postgres-public-COW'].get('version'), new_version)
...
class FullTableInterruption(unittest.TestCase):
    ...
    def test_catalog(self):
        ...
        chicken_stream = [
            s for s in streams if s['table_name'] == 'CHICKEN'][0]
        ...
        self.assertTrue(isinstance(
            CAUGHT_MESSAGES[5], singer.ActivateVersionMessage))
        self.assertEqual(CAUGHT_MESSAGES[5].version, new_version)

        self.assertTrue(isinstance(CAUGHT_MESSAGES[6], singer.StateMessage))
        self.assertEqual(None, singer.get_currently_syncing(
            CAUGHT_MESSAGES[6].value))
        ...
        self.assertTrue(isinstance(
            CAUGHT_MESSAGES[9], singer.ActivateVersionMessage))
        ...
        self.assertEqual(CAUGHT_MESSAGES[1].value['bookmarks']
                         ['postgres-public-COW']['version'], cow_version)
        self.assertIsNotNone(
        ...
        self.assertEqual(singer.get_currently_syncing(
            CAUGHT_MESSAGES[3].value), 'postgres-public-COW')
        ...
        self.assertEqual(singer.get_currently_syncing(
            CAUGHT_MESSAGES[5].value), 'postgres-public-COW')
        ...
        self.assertTrue(isinstance(CAUGHT_MESSAGES[7], singer.StateMessage))
        self.assertIsNone(singer.get_currently_syncing(
            CAUGHT_MESSAGES[7].value))
        self.assertIsNone(
